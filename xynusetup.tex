...
\xynusetup{
  %title                = {\CJKunderline[thickness=1.5bp, depth=0.12em, sep=0.04em]{信阳师范大学学位论文模板示例文档 v0.1}},
  ...
  supervisor           = {XXX~教授},% 导师
  supervisor*          = {Prof. XXX},
  practice-supervisor  = {XXX~教授},  % 校外导师
  practice-supervisor* = {Prof. XXX},
  % date                 = {2017-05-01},  % 论文提交日期，默认为今日
